...
export default function LoginPage() {
  ...
  const handleAdPartner = () => {
    navigate("/adpartner")
  }
  const handleSorterManager = () =>{
    navigate("/sortermanager")
  }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white">
      <div className="w-full max-w-[320px] bg-white">
        ...
        {/* Google Login */}
        <Button onClick={handleAdPartner} variant="outline" type="button" className="w-full h-10 bg-slate-900 hover:bg-slate-800 mt-10 tracking-[0.07px] text-white hover:text-white">
        ...
        {/* Login Buttons */}
        <Button onClick={handleSorterManager}
